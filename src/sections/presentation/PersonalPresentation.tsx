          ...
          <div style={{ maxWidth: "100%", display: "flex", flexWrap: "wrap" }}>
            <div className={styles.anto}>
              ...
              <p>
                ...
                procesos de cambio. También disfruto mucho de mantenerme siempre
                activa aprendiendo y compartiendo con mis colegas.
              </p>
              <br />
              <p>
          ...
          <div style={{ maxWidth: "100%", display: "flex", flexWrap: "wrap" }}>
            <div className={styles.dana}>
              <p>
                ...
                contarles un poco de mí: soy licenciada en psicología y trabajo
                haciendo psicoterapia clínica desde el día que me recibí desde
              ...
              <br />
              <p>
                El compromiso que siento por esta vocación me hace querer llegar
                a ustedes para acompañarlos en su camino personal, descubriendo
                recursos y potenciando nuevos.
              </p>
              <br />
              <p>
